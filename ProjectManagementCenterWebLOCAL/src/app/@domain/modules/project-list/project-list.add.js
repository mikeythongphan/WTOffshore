 ...
 * @returns 
 */
export const ProjectListAdd = props => {
 ...
 const onSubmit = () => {
  ...
  obj.projectListComments = projectListCommentModel.toRemoteObjs(comments());
  api.projectListApi.insert(obj).then(result => {
   onClose();
   loadModelDataFunc();
   comments([]);
 ...
 return <Dialog fullScreen style={{ margin: 'auto', maxWidth: 1000, maxHeight: 800 }}
  ...
  <DialogContent dividers={true}>
   ...
   <Divider />
   <ProjectListComment local={true} readonly={false} />
   <br />
  </DialogContent>
  <DialogActions>

export class DrillWellCommentModel {
  ...
  toRemoteObj = srcObj => {
    ...
    const obj = {...srcObj};
    obj.drillWellId = obj.drillWellId === '' ? null : parseInt(obj.drillWellId);
...
export const drillWellCommentModel = new DrillWellCommentModel();
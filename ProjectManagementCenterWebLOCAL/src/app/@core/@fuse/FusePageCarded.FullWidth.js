...
import FusePageCardedSidebar from 'src/@fuse/core/FusePageCarded/FusePageCardedSidebar';
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-auto flex-col z-10 h-full shadow-1 relative overflow-hidden" style={{margin: '0 5px 0 5px'}}>
